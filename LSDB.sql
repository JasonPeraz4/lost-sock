...
INSERT INTO compra
VALUES	(DEFAULT, '2020-02-17', NOW(), 9.98, 2, 1, 1),
		(DEFAULT, '2020-02-17', NOW(), 9.00, 4, 2, 2),
		(DEFAULT, '2020-02-11', NOW(), 9.00, 3, 3, 3),
		(DEFAULT, '2020-02-7', NOW(), 10.00, 4, 4, 2),
		...
		(DEFAULT, '2020-02-17', NOW(), 9.98, 2, 10, 3),
		...
		(DEFAULT, '2020-02-17', NOW(), 15.00, 3, 2, 4),
		(DEFAULT, '2020-02-17', NOW(), 15.00, 2, 2, 3),
		(DEFAULT, '2020-02-17', NOW(), 18.00, 4, 10, 5),
		...
		(DEFAULT, '2020-02-17', NOW(), 20.00, 2, 7, 2),
		(DEFAULT, '2020-02-17', NOW(), 19.96, 2, 6, 3),
		(DEFAULT, '2020-02-17', NOW(), 20.00, 3, 5, 1),
		(DEFAULT, '2020-02-17', NOW(), 24.00, 2, 4, 2),
		(DEFAULT, '2020-02-17', NOW(), 16.00, 3, 3, 4),
		(DEFAULT, '2020-02-17', NOW(), 24.00, 2, 2, 1),
		(DEFAULT, '2020-02-17', NOW(), 20.00, 2, 1, 4),
		(DEFAULT, '2020-02-17', NOW(), 24.95, 4, 1, 4),
		(DEFAULT, '2020-02-17', NOW(), 22.50, 2, 2, 2),
		(DEFAULT, '2020-02-17', NOW(), 30.00, 3, 3, 3),
		(DEFAULT, '2020-02-16', NOW(), 25.00, 4, 4, 5),
		(DEFAULT, '2020-02-11', NOW(), 25.00, 2, 5, 4),
		...
		(DEFAULT, '2020-06-2', NOW(), 25.00, 3, 10, 3);
