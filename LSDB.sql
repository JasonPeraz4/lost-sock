...
INSERT INTO compra
VALUES	(DEFAULT, '2020-02-17', NOW(), 9.98, DEFAULT, 2, 1, 1),
		(DEFAULT, '2020-02-17', NOW(), 9.00, DEFAULT, 4, 2, 2),
		(DEFAULT, '2020-02-11', NOW(), 9.00, DEFAULT, 3, 3, 3),
		(DEFAULT, '2020-02-7', NOW(), 10.00, DEFAULT, 4, 4, 2),
		(DEFAULT, '2020-02-12', NOW(), 9.98, DEFAULT, 2, 5, 3),
		(DEFAULT, '2020-02-12', NOW(), 12.00, DEFAULT, 3, 6, 4),
		(DEFAULT, '2020-02-16', NOW(), 9.00, DEFAULT, 4, 7, 5),
		(DEFAULT, '2020-02-15', NOW(), 10.00, DEFAULT, 3, 8, 3),
		(DEFAULT, '2020-02-9', NOW(), 10.00, DEFAULT, 4, 9, 2),
		(DEFAULT, '2020-02-17', NOW(), 9.98, DEFAULT, 2, 10, 3),
		(DEFAULT, '2020-02-17', NOW(), 16.00, DEFAULT, 3, 11, 5),
		(DEFAULT, '2020-02-17', NOW(), 15.00, DEFAULT, 4, 12, 2),
		(DEFAULT, '2020-02-17', NOW(), 15.00, DEFAULT, 2, 13, 4),
		(DEFAULT, '2020-02-8', NOW(), 14.00, DEFAULT, 3, 1, 3),
		(DEFAULT, '2020-02-17', NOW(), 15.00, DEFAULT, 3, 2, 4),
		(DEFAULT, '2020-02-17', NOW(), 15.00, DEFAULT, 2, 2, 3),
		(DEFAULT, '2020-02-17', NOW(), 18.00, DEFAULT, 4, 10, 5),
		(DEFAULT, '2020-02-17', NOW(), 14.00, DEFAULT, 3, 13, 1),
		(DEFAULT, '2020-02-17', NOW(), 16.00, DEFAULT, 3, 12, 2),
		(DEFAULT, '2020-02-17', NOW(), 15.00, DEFAULT, 3, 11, 2),
		(DEFAULT, '2020-02-17', NOW(), 18.00, DEFAULT, 3, 10, 5),
		(DEFAULT, '2020-02-17', NOW(), 20.00, DEFAULT, 4, 9, 4),
		(DEFAULT, '2020-02-17', NOW(), 19.00, DEFAULT, 4, 8, 4),
		(DEFAULT, '2020-02-17', NOW(), 20.00, DEFAULT, 2, 7, 2),
		(DEFAULT, '2020-02-17', NOW(), 19.96, DEFAULT, 2, 6, 3),
		(DEFAULT, '2020-02-17', NOW(), 20.00, DEFAULT, 3, 5, 1),
		(DEFAULT, '2020-02-17', NOW(), 24.00, DEFAULT, 2, 4, 2),
		(DEFAULT, '2020-02-17', NOW(), 16.00, DEFAULT, 3, 3, 4),
		(DEFAULT, '2020-02-17', NOW(), 24.00, DEFAULT, 2, 2, 1),
		(DEFAULT, '2020-02-17', NOW(), 20.00, DEFAULT, 2, 1, 4),
		(DEFAULT, '2020-02-17', NOW(), 24.95, DEFAULT, 4, 1, 4),
		(DEFAULT, '2020-02-17', NOW(), 22.50, DEFAULT, 2, 2, 2),
		(DEFAULT, '2020-02-17', NOW(), 30.00, DEFAULT, 3, 3, 3),
		(DEFAULT, '2020-02-16', NOW(), 25.00, DEFAULT, 4, 4, 5),
		(DEFAULT, '2020-02-11', NOW(), 25.00, DEFAULT, 2, 5, 4),
		(DEFAULT, '2020-02-12', NOW(), 22.50, DEFAULT, 4, 6, 5),
		(DEFAULT, '2020-06-1', NOW(), 24.95, DEFAULT, 2, 7, 2),
		(DEFAULT, '2020-06-7', NOW(), 30.00, DEFAULT, 3, 8, 4),
		(DEFAULT, '2020-06-5', NOW(), 22.50, DEFAULT, 4, 9, 2),
		(DEFAULT, '2020-06-2', NOW(), 25.00, DEFAULT, 3, 10, 3);
