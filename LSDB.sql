...
VALUES	(DEFAULT, 1, 5.00, 14, 1),
		...
		(DEFAULT, 2, 10.00, 2, 3),
		(DEFAULT, 1, 5.00, 18, 4),
		(DEFAULT, 3, 15.00, 10, 4),
		(DEFAULT, 1, 5.00, 12, 5),
		(DEFAULT, 1, 5.00, 16, 5),
		(DEFAULT, 1, 5.00, 2, 6),
		(DEFAULT, 2, 10.00, 14, 6),
		(DEFAULT, 1, 5.00, 17, 7),
		(DEFAULT, 2, 10.00, 20, 7),
		(DEFAULT, 3, 15.00, 19, 8),
		(DEFAULT, 2, 10.00, 6, 8),
		(DEFAULT, 2, 10.00, 7, 9),
		(DEFAULT, 3, 15.00, 3, 9),
		(DEFAULT, 2, 10.00, 13, 10),
		(DEFAULT, 1, 5.00, 4, 10),
		(DEFAULT, 3, 15.00, 11, 11),
		(DEFAULT, 2, 10.00, 6, 11),
		(DEFAULT, 2, 10.00, 1, 11),
		(DEFAULT, 3, 15.00, 3, 12),
		(DEFAULT, 2, 10.00, 13, 12),
		(DEFAULT, 1, 5.00, 7, 12),
		(DEFAULT, 3, 15.00, 19, 13),
		(DEFAULT, 2, 10.00, 6, 13),
		(DEFAULT, 2, 10.00, 16, 13),
		(DEFAULT, 3, 15.00, 3, 14),
		(DEFAULT, 2, 10.00, 13, 14),
		(DEFAULT, 1, 5.00, 18, 14),
		(DEFAULT, 3, 15.00, 19, 15),
		(DEFAULT, 2, 10.00, 2, 15),
		(DEFAULT, 2, 10.00, 11, 15),
		(DEFAULT, 3, 15.00, 1, 16),
		(DEFAULT, 2, 10.00, 13, 16),
		(DEFAULT, 1, 5.00, 15, 16),
		(DEFAULT, 3, 15.00, 10, 17),
		(DEFAULT, 2, 10.00, 3, 17),
		(DEFAULT, 2, 10.00, 9, 17),
		(DEFAULT, 3, 15.00, 15, 18),
		(DEFAULT, 2, 10.00, 10, 18),
		(DEFAULT, 1, 5.00, 9, 18),
		(DEFAULT, 3, 15.00, 4, 19),
		(DEFAULT, 2, 10.00, 17, 19),
		(DEFAULT, 2, 10.00, 8, 19),
		(DEFAULT, 3, 15.00, 14, 20),
		(DEFAULT, 2, 10.00, 19, 20),
		(DEFAULT, 1, 5.00, 20, 20),
		(DEFAULT, 2, 10.00, 10, 21),
		(DEFAULT, 1, 5.00, 20, 21),
		(DEFAULT, 1, 5.00, 1, 21),
		(DEFAULT, 1, 5.00, 11, 21),
		(DEFAULT, 2, 10.00, 18, 22),
		(DEFAULT, 2, 10.00, 17, 22),
		(DEFAULT, 1, 10.00, 6, 22),
		(DEFAULT, 2, 10.00, 12, 22),
		(DEFAULT, 2, 10.00, 13, 23),
		(DEFAULT, 1, 5.00, 16, 23),
		(DEFAULT, 1, 5.00, 4, 23),
		(DEFAULT, 2, 10.00, 8, 23),
		(DEFAULT, 1, 5.00, 3, 24),
		(DEFAULT, 3, 15.00, 7, 24),
		(DEFAULT, 1, 5.00, 4, 24),
		(DEFAULT, 1, 5.00, 19, 24),
		(DEFAULT, 3, 15.00, 14, 25),
		(DEFAULT, 1, 5.00, 15, 25),
		(DEFAULT, 2, 10.00, 4, 25),
		(DEFAULT, 2, 10.00, 3, 25),
		(DEFAULT, 1, 5.00, 19, 26),
		(DEFAULT, 1, 5.00, 4, 26),
		(DEFAULT, 1, 5.00, 6, 26),
		(DEFAULT, 1, 5.00, 10, 26),
		(DEFAULT, 2, 10.00, 8, 27),
		(DEFAULT, 1, 5.00, 2, 27),
		(DEFAULT, 1, 5.00, 18, 27),
		(DEFAULT, 1, 5.00, 13, 27),
		(DEFAULT, 2, 10.00, 8, 28),
		(DEFAULT, 1, 5.00, 16, 28),
		(DEFAULT, 2, 10.00, 10, 28),
		(DEFAULT, 1, 5.00, 9, 28),
		(DEFAULT, 2, 10.00, 7, 29),
		(DEFAULT, 1, 5.00, 9, 29),
		(DEFAULT, 3, 15.00, 3, 29),
		(DEFAULT, 1, 5.00, 17, 29),
		(DEFAULT, 1, 5.00, 8, 30),
		(DEFAULT, 3, 15.00, 5, 30),
		(DEFAULT, 2, 10.00, 12, 30),
		(DEFAULT, 1, 5.00, 4, 30),
		(DEFAULT, 2, 10.00, 10, 31),
		(DEFAULT, 1, 5.00, 12, 31),
		(DEFAULT, 2, 10.00, 4, 31),
		(DEFAULT, 1, 5.00, 3, 31),
		(DEFAULT, 3, 15.00, 20, 31),
		(DEFAULT, 1, 5.00, 11, 32),
		(DEFAULT, 1, 5.00, 18, 32),
		(DEFAULT, 3, 15.00, 16, 32),
		(DEFAULT, 2, 10.00, 5, 32),
		(DEFAULT, 1, 5.00, 8, 32),
		(DEFAULT, 2, 10.00, 6, 33),
		(DEFAULT, 1, 5.00, 9, 33),
		(DEFAULT, 2, 10.00, 4, 33),
		(DEFAULT, 1, 5.00, 19, 33),
		(DEFAULT, 3, 15.00, 13, 33),
		(DEFAULT, 1, 5.00, 17, 34),
		(DEFAULT, 1, 5.00, 18, 34),
		(DEFAULT, 3, 15.00, 15, 34),
		(DEFAULT, 2, 10.00, 12, 34),
		(DEFAULT, 1, 5.00, 14, 34),
		(DEFAULT, 2, 10.00, 2, 35),
		(DEFAULT, 1, 5.00, 5, 35),
		(DEFAULT, 2, 10.00, 6, 35),
		(DEFAULT, 1, 5.00, 8, 35),
		(DEFAULT, 3, 15.00, 3, 35),
		(DEFAULT, 1, 5.00, 14, 36),
		(DEFAULT, 1, 5.00, 8, 36),
		(DEFAULT, 3, 15.00, 5, 36),
		(DEFAULT, 2, 10.00, 11, 36),
		(DEFAULT, 1, 5.00, 16, 36),
		(DEFAULT, 2, 10.00, 20, 37),
		(DEFAULT, 1, 5.00, 9, 37),
		(DEFAULT, 2, 10.00, 1, 37),
		(DEFAULT, 1, 5.00, 13, 37),
		(DEFAULT, 3, 15.00, 3, 37),
		(DEFAULT, 1, 5.00, 14, 38),
		(DEFAULT, 1, 5.00, 20, 38),
		(DEFAULT, 3, 15.00, 13, 38),
		(DEFAULT, 2, 10.00, 11, 38),
		(DEFAULT, 1, 5.00, 4, 38),
		(DEFAULT, 2, 10.00, 10, 39),
		(DEFAULT, 1, 5.00, 1, 39),
		(DEFAULT, 2, 10.00, 15, 39),
		(DEFAULT, 1, 5.00, 16, 39),
		(DEFAULT, 3, 15.00, 3, 39),
		(DEFAULT, 1, 5.00, 17, 40),
		(DEFAULT, 1, 5.00, 8, 40),
		(DEFAULT, 3, 15.00, 5, 40),
		(DEFAULT, 2, 10.00, 12, 40),
		(DEFAULT, 1, 5.00, 2, 40);
