...
<table id="myTable" class="table table-responsive-sm table-hover">
    ...
    <tbody id="tbody-rows" class="table-bordered">
        <tr>
            ...
            <td>
                <i class="fas fa-info mx-1" onclick="openInfoModal()" data-toggle="tooltip" title="Ver detalle"></i>
                <i class="fas fa-ban" onclick="openCancelModal()" data-toggle="tooltip" title="Cancelar pedido"></i>
            </td>
        </tr>
    </tbody>
</table>
