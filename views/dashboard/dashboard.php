...
<div class="row">
    <div class="col-md-4">
        <div class="row">
            <div class="col">
                <div class="card card-dashboard border-purple mb-3 w-md-50">
                    <div class="card-header text-purple border-purple">Orders</div>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-dashboard border-purple mb-3 w-md-50">
                    <div class="card-header text-purple border-purple">Suscriptions</div>
                    <div class="card-body text-purple">
