    ...
    <div class="row">
        <div class="col-12 col-md-5 border mr-5 bg-white py-4 mb-sm-4 mb-md-0">
            ...
            <form method="post" id="profile-form" class="p-3" enctype="multipart/form-data">
                ...
                <h6 class="my-3 text-muted">ACCOUNT INFORMATION</h6>
                <div class="form-group">
                ...
                <button type="submit" class="btn custom--button text-white d-flex justify-content-center mx-auto">Update</button>
            </form>
            <form method="post" id="password-form" class="p-3">
                <h6 class="mb-3 text-muted">ACCOUNT ACCESS</h6>   
                <div class="form-group">
        ...
        <div class="col-12 col-md-6 border bg-white py-4">
            <form method="post" class="p-3" id="direcciones-form">
                <h6 class="mb-3 text-muted">SHIPPING INFORMATION <small id="lblAgregar" onclick="openCreateModal()" class="ml-auto text-purple"><a href="#">Add new address</a></small> </h6>
                <div id="direcciones-body">
                    ...
                    <h6>There are no address added yet</h6>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form method="post" novalidate="" id="save-form">
        <div class="modal-body p-md-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="departamento_direccion">Department</label>
