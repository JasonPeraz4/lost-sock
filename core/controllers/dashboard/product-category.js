...
const API_CATEGORIA = '../../core/api/dashboard/product-category.php?action=';
    ...
    dataset.forEach(function (row) {
        ...
        content += `
            ...
            <tr>
                <td>${row.categoria}</td>
                <td>
                    <a class="fas fa-edit mx-1" data-toggle="modal" data-target="#nuevaCategoria(${row.idCategoria})"></a>
                    <a class="fas fa-trash-alt" data-toggle="modal" data-target="#eliminarCategoria(${row.idCategoria})"></a>
                </td>
            </tr>
        `;
    });
...
$('#save-form').submit(function (event) {
    ...
    if ($('#id_categoria').val()) {
        saveRow(API_CATEGORIA, 'update', this, 'save-modal');
    } else {
        saveRow(API_CATEGORIA, 'create', this, 'save-modal');
    }
});
